...
export default function Contact() {
    ...
    <div className="section-header">
      <div className="containerC">
        <h2>Contact Us</h2>
        <p>Welcome to our Healthawy Nutrition contact us page! we're here to answer your question, provide guidence,and share knowledge on the path to a healthier and more balanced lifestyle</p>
      </div>
    </div>
